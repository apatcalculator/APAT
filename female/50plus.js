$(window).load(function(){
	...
	$('input').keyup(function(){
	    ...
	    if (sit >= 24) {document.getElementById("SitUp").innerHTML = "Excellent";}
	    if (sit <= 23 & sit >= 20) {document.getElementById("SitUp").innerHTML = "Good";}
	    ...
	    if (total <= 956) {document.getElementById("RunTime").innerHTML = "Excellent";}
	    if (total <= 1018 & total >= 957) {document.getElementById("RunTime").innerHTML = "Good";}
	    if (total <= 1074 & total >= 1019) {document.getElementById("RunTime").innerHTML = "Fair";}
	    if (total <= 1129 & total >= 1075) {document.getElementById("RunTime").innerHTML = "Poor";}
	    if (total >= 1130) {document.getElementById("RunTime").innerHTML = "Very Poor";}
